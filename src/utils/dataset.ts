...
const COLOUR_MAPPING = new Map<string, Scaling>([
    ...
    ["Percentage of individuals using the internet", { type: "Threshold", colourScheme: "Mono", thresholdType: "", thresholds: [] }],
    ["Population aged 0 to 14 years old (percentage)", { type: "Threshold", colourScheme: "Mono", thresholdType: "", thresholds: [] }],
    ["Population aged 60+ years old (percentage)", { type: "Threshold", colourScheme: "Mono", thresholdType: "", thresholds: [] }],
